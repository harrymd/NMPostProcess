...
from common import get_list_of_modes_from_coeff_files, load_vsh_coefficients, make_l_and_m_lists, read_input_NMPostProcess

# Characterisation of modes based on their VSH coefficients. ------------------
def calculate_power_distribution_quick(Ulm, Vlm, Wlm, l_list, print_ = True):
    '''
